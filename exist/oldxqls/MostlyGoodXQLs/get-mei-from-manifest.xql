...
(:
    get-mei-from-manifest.json.xql

    This xQuery retrieves a valid MEI file from manifest.json data
    
    So far just a copy of get-manifest.xql
:)
...
(:let $document.uri := 'https://api.domestic-beethoven.eu/iiif/document/' || $document.id || '/':)
...
let $attribution := 'Beethoven in the House'
